    ...
    for(i in ret)
    {
        ...
        else if(("topic"==type)||("homepage"==type))
        {
            if("topic"==type)
            {
                ...
                var answer_like_nums=ret[i][7];
                var answer_comment_nums=ret[i][8];
