...
function load_qq_lrc(a){var b=new Object;return b.extra_top=1,b.current=-1,b.current_obj,b.offset=0,b.current_start=-1,b.next_update_time=-1,b.showtime=-1,b.lrc_offset=-1,b.lrc_height=-1,b.lrc=[],b.lrcobj=null,b.target=0,b._target=0,b.player_obj=document.getElementById(a),b.lrc_obj=document.getElementById(a+"_lrc"),b.scroll_lrc=function(){if("undefined"!=typeof b.lrc[b.current+2]){for(id in b.lrcobj)b.lrcobj[id].className="";b.lrcobj[b.current+3].className="current"}b.current_start=b.lrc[b.current],b.current++,b.current_obj=b.lrcobj[b.current+2],b.next_update_time=b.lrc[b.current],b.showtime=b.next_update_time-b.current_start,b.lrc_offset=b.current_obj.offsetTop,b.lrc_height=b.current_obj.offsetHeight},b.check_lrc_update=function(){var a=b.player_obj.currentTime;a>=b.next_update_time-.2&&(b.scroll_lrc(),b.check_lrc_update()),"undefined"!=typeof b.lrc[b.current-1]&&(b.extra_top=(b.next_update_time-a)/b.showtime),b.target=Math.round(b.lrc_offset-(125-b.lrc_height)/2),b.target<0&&(b.target=0)},b.init=function(){b.add_lrcarr([[999999,""],[999999,""],[999999,""]]),b.current=-1,b.lrcobj=b.lrc_obj.getElementsByTagName("li"),b.current_obj=b.lrcobj[0],b.scroll_lrc(),b.check_lrc_update(),b.player_obj.addEventListener("seeked",function(){b.current=-1,b.scroll_lrc(),b.check_lrc_update()}),b.player_obj.addEventListener("durationchange",function(){b.current=-1,b.scroll_lrc(),b.check_lrc_update()}),setInterval(function(){b.player_obj.paused||(b.current_start>b.player_obj.currentTime?(b.current=-1,b.scroll_lrc(),b.check_lrc_update()):b.check_lrc_update())},100),setInterval(function(){b._target!=b.target&&(Math.abs(b.lrc_obj.scrollTop-b._target)>b.lrc_height&&(b._target=b.lrc_obj.scrollTop),b._target=b.player_obj.paused?b.fixFloat(.8*b._target+.2*b.target):b.fixFloat(.95*b._target+.05*b.target),b.lrc_obj.scrollTop=b._target)},5)},b.add_lrcarr=function(a){var c=a.length;for(i=0;c>i;i++){b.lrc.push(a[i][0]+b.offset);var d=document.createElement("li");d.innerHTML=a[i][1],b.lrc_obj.appendChild(d)}},b.loadurl=function(a){var c=get_xmlhttp();null!=c&&(c.onreadystatechange=function(){if(4==c.readyState&&200==c.status){var a=c.responseText,d=parseLyric(a);b.add_lrcarr(d),b.init()}},c.open("GET",a,!0),c.send())},b.get_lrc=function(a){return"undefined"!=typeof b.lrc[a]?b.lrc[a][1]:""},b.setoffset=function(a){b.offset=a/1e3},b.fixFloat=function(a){return Math.ceil(10*a)/10},b}function parseLyric(a){var b=a.split("\n");lrc=new Array;var c=b.length;for(i=0;c>i;i++){var d=b[i].match(/\[\d{2}:\d{2}((\.|\:)\d{2})\]/g),e=b[i].replace(/\[\d{2}:\d{2}((\.|\:)\d{2})\]/g,"");if(null!=d){var f=d.length;for(j=0;f>j;j++){var g=d[j],h=Number(String(g.match(/\[\d{2}/i)).slice(1)),k=parseFloat(String(g.match(/\d{2}\.\d{2}/i))),l=Math.round(100*(60*h+k))/100;lrc.push([l,e])}}}return lrc.sort(function(a,b){return a[0]-b[0]}),lrc}function get_xmlhttp(){var a=null;try{a=new XMLHttpRequest}catch(b){try{a=new ActiveXObject("Msxml2.XMLHTTP")}catch(b){a=new ActiveXObject("Microsoft.XMLHTTP")}}return a};
/*!player*/
