...
class Answer(models.Model):
    question=models.ForeignKey(Question,related_name='write_answers',on_delete=models.CASCADE)
...
class Comment(models.Model):
    author=models.ForeignKey(User,related_name='write_comments',on_delete=models.CASCADE)
